...
"""
    ...
    def record_state_frames(self, out_prefix: str, rows: list[ReactiveSiteStateFrame]) -> None:
        if not rows:
            return
    ...
    def record_events(self, out_prefix: str, rows: list[ReactiveSiteEvent]) -> None:
        if not rows:
            return
    ...
    def record_joint_reactions(self, out_prefix: str, rows: list[JointReactiveSiteReaction]) -> None:
        if not rows:
            return
