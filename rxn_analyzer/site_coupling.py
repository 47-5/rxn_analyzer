...
from .site_model import ReactiveSiteEvent, ReactiveSiteStateFrame, SiteReactionCouplingRow
...
def build_site_reaction_couplings(
    ...
    site_states: list[ReactiveSiteStateFrame],
    site_events: list[ReactiveSiteEvent],
