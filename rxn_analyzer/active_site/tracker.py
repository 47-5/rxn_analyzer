...
class ActiveSiteTracker:
    def __init__(self) -> None:
        self.prev_states: dict[str, ActiveSiteStateFrame] = {}
        self.events: list[ActiveSiteEvent] = []
        self.joint_reactions: list[JointActiveSiteReaction] = []

    @staticmethod
    def _filter_evidence(site_prev: ActiveSiteStateFrame | None,
                         site_curr: ActiveSiteStateFrame,
